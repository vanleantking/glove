...
class GloVeModel():
    ...
    def train(self, num_epochs, log_dir=None, summary_batch_interval=1000,
        ...
        with tf.Session(graph=self.__graph) as session:
            ...
            saver.save(session, "/media/vanle/Studying/python/word2vec/glove/thesis/corpus/tf_glove.model", global_step=total_steps)
    ...
    def restore(checkpoint_file='tf_glove.model'):
        ...
        if tf.train.latest_checkpoint(save_dir) is not None:
            with tf.Session() as session:
                ...
                saver = tf.train.import_meta_graph(save_dir+'tf_glove.model-102450.meta')
